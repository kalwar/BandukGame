   ...
   implements SurfaceHolder.Callback
{
   ...
   public static final int TARGET_PIECES = 9; // sections in the target
   ...
   public void newGame()
   {
      ...
      timeLeft = 30; // start the countdown at 60 seconds
   ...
   private void updatePositions(double elapsedTimeMS)
   {
            ...
            cannonball.y - cannonballRadius < target.end.y)
         {
               ...
               !hitStates[section])
            {
               ...
               if (++targetPiecesHit == TARGET_PIECES)
               {
                  ...
                  GameData.updateGameWinResults(this,true);
                  gameOver = true; 
               } 
            }
         }
      ...
      if (timeLeft <= 0.0)
      {
         ...
         GameData.updateGameLoseResults(this,false);
      } 
   ...
   public void drawGameElements(Canvas canvas)
   {
     ...
     // canvas.drawCircle(cannonBaseRadius, (float) Math.cos(0) * cannonBaseRadius + screenWidth / 2, (float) Math.sin(0) * cannonBaseRadius + screenHeight / 2);
